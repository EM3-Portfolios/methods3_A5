...
library(metafor)
data <- escalc(measure = "SMD", #SMD stands for standard mean difference AKA Cohen's d
               n1i = , n2i = , #for this i think we should make 2 new columns from the ones called MALE_SZ + FEMALE_SZ = n_SZ (and same for HC)
