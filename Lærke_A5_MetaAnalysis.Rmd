...
# I^2: 
# - 75% = high variance
# - 25 – 50 % moderate variance
# - < 25 % low variance

# Tau^2:
# - The lower the value, the lower the heterogeneity (0 when no heterogeneity)


# When we included our study in the analysis, the overall variance fell from tau^2 = 0.07 (SE = 0.09) to tau^2 = 0.05 (SE = 0.06). This means that the meta-study became more homogeneous, when we added our data from portfolio 3 to the given meta-analysis data. The proportion of variance due to heterogeneity was moderate to high - both with and without the portfolio 3 data. When we added the portfolio 3 data, it rose from I^2 = 50.3% to I^2 = 55.5%. ...
# ... XXX What does this mean? XXX
